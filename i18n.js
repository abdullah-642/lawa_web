...
const I18N = {
  ar: {
    ...
    "hero.t2": "المساحة",
    "hero.t3": "من حولك.",
    "hero.sub": "ديكورات عصرية بلمسة فنية، تُصمَّم بعناية وتُنفَّذ بإتقان.",
    "hero.cta1": "احجز استشارتك",
    ...
    "exp.title1": "خدماتٌ متخصصة",
    "exp.title2": "بإتقان احترافي.",
    "exp.lead": "نمتلك خبرة عميقة في تنفيذ المشاريع التي تتطلب دقة تقنية عالية ومواصفات صارمة.",
    "exp.c1.t": "مشاريع سبا",
    "exp.c1.p": "تصميم وتنفيذ مرافق السبا الفاخرة: الحمامات المغربية، غرف البخار، كهوف الملح، وغرف الثلج بأعلى المعايير الفنية والصحية.",
    "exp.c2.t": "المطاعم والمحلات",
    "exp.c2.p": "تصميم تجارب مكانية متكاملة تُجسّد هوية العلامة التجارية وتُحوّلها إلى تجربة استثنائية للزائر.",
    "exp.c3.t": "المساحات الإدارية",
    ...
    "meth.title2": "من الفكرة حتى التسليم.",
    "meth.lead": "تنطلق كل رحلة مشروع لدينا من فهم عميق لطبيعة النشاط ومتطلبات العميل، تليها مرحلة تصميم تُوازن بين الجمال والوظيفة، وتُتوَّج بمواصفات فنية موثّقة ومواد مُختارة بعناية فائقة.",
    "meth.s1.t": "الاستكشاف",
    "meth.s1.p": "جلسات تشاورية متعمّقة لفهم طبيعة النشاط، الجمهور المُستهدف، والتطلعات المستقبلية.",
    "meth.s2.t": "التصور",
    "meth.s2.p": "صياغة الرؤية البصرية للمكان بأسلوب يُوازن بين الجمال والوظيفة بإتقان.",
    "meth.s3.t": "التصميم الفني",
    "meth.s3.p": "إعداد الرسومات التنفيذية والمواصفات الفنية الموثّقة لكل عنصر من عناصر المشروع.",
    "meth.s4.t": "التنفيذ والإشراف",
    "meth.s4.p": "متابعة ميدانية مباشرة تضمن تطابق المُنفَّذ مع التصميم المُعتمد دون أي تنازل.",

    "vis.kicker": "04 — رؤيتنا",
    "vis.q1": "نتطلع أن نكون",
    "vis.q2": " البيت الأول ",
    "vis.q3": "الذي يقصده الباحثون في المملكة العربية السعودية عن جهة تجمع بين الإبداع التصميمي والإتقان التنفيذي، دون أي مساس بدقة التفاصيل.",
    ...
    "cli.title1": "ثقتهم",
    "cli.title2": "شهادتنا الحقيقية.",
    "cli.lead": "شَرُفنا على مدى سنوات بمرافقة نُخبة من العملاء في بناء مساحات تُجسّد هوياتهم وتُلبّي تطلعاتهم بدقة متناهية.",
    "cli.note": "* ضع شعارات عملائك داخل مجلد assets/clients/ وسأقوم بربطها تلقائياً.",

    "con.kicker": "06 — تواصل",
    "con.title1": "لنبدأ",
    "con.title2": "رحلة مشروعك.",
    "con.lead": "شاركنا تفاصيل مشروعكم، وسيتولى فريقنا المتخصص ترجمتها إلى مكان استثنائي يتجاوز التوقعات — بإشراف مباشر من الفكرة الأولى حتى تسليم المفتاح.",
    "con.wa": "واتساب",
    "con.em": "بريد",
    "con.lo": "الموقع",
    ...
    "foot.tag": "علامة تجارية ضمن مجموعة غرين زون · تأسست 2017",
    "foot.nav": "روابط",
    "foot.con": "تواصل",
  ...
  en: {
    ...
    "meth.s2.t": "Envision",
    "meth.s2.p": "We shape the space with visual precision that balances beauty and function.",
    "meth.s3.t": "Design",
